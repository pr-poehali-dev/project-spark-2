            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  ...
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    «Моцарт психологии» — основатель культурно-исторической теории развития сознания
                  </div>
                </div>
              </div>
                  ...
                  <Badge
                    icon={
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M6 3.5V6L7.5 7.5" stroke="#37322F" strokeWidth="1" strokeLinecap="round" />
                      </svg>
                    }
                    text="1896–1934 · Психолог, педагог, мыслитель"
                  />
                </div>
              </div>
                      ...
                      <div className="relative w-full h-full overflow-hidden">
                        ...
                        >
                          <img
                            ...
                            alt="Культурно-историческая теория"
                            className="w-full h-full object-cover"
                          />
                        </div>
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b border-[#E0DEDB] flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  <FeatureCard
                    title="Биография"
                    description="Родился в Орше. Окончил юрфак МГУ. В 1924 году выступил на съезде психоневрологов и произвёл революцию в науке."
                  ...
                  <FeatureCard
                    ...
                    description="Высшие психические функции — внимание, память, мышление — возникают сначала как коллективное поведение, затем становятся внутренними."
                  ...
                  <FeatureCard
                    ...
                    description="Разрыв между тем, что ребёнок умеет сам, и тем, что он делает с помощью взрослого — фундамент современной педагогики."
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
                    ...
                    <div className="w-full text-center flex justify-center flex-col text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
                      Идеи, изменившие психологию
                    </div>
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Труды Выготского продолжают влиять на педагогику,
                      <br className="hidden sm:block" />
                      когнитивную науку и теорию воспитания по всему миру.
                    </div>
                  </div>
                </div>
                ...
                <div className="self-stretch flex justify-center items-start">
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    ...
                    <div className="border-b border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        <h3 className="text-[#37322F] text-lg sm:text-xl font-semibold leading-tight font-sans">
                          Ваша работа в синхронизации
                        </h3>
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Держите всё в гармонии — задачи, команду и сроки всегда под контролем.
                        </p>
                      </div>
                      <div className="w-full h-[200px] sm:h-[250px] md:h-[300px] rounded-lg flex items-center justify-center overflow-hidden">
                        <YourWorkInSync
                    ...
                    <div className="border-b border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        <h3 className="text-[#37322F] text-lg sm:text-xl font-semibold leading-tight font-sans">
                          Интеграция без усилий
                        </h3>
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Подключайте любые инструменты — всё работает вместе бесшовно.
                        </p>
                      </div>
                      <div className="w-full h-[200px] sm:h-[250px] md:h-[300px] rounded-lg flex items-center justify-center overflow-hidden">
                    ...
                    <div className="border-b border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Реальные метрики роста, которые показывают прогресс вашей команды.
                        </p>
                      </div>
                      <div className="w-full h-[200px] sm:h-[250px] md:h-[300px] rounded-lg flex items-center justify-center overflow-hidden">
                        <NumbersThatSpeak
