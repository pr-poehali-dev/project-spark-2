...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Обучение должно идти впереди развития, ведя его за собой.",
      name: "Л.С. Выготский",
      company: "«Мышление и речь», 1934",
      image:
    ...
    {
      quote:
        "Что ребёнок умеет делать сегодня в сотрудничестве, завтра он сможет сделать самостоятельно.",
      name: "Л.С. Выготский",
      company: "Зона ближайшего развития",
      image:
    ...
    {
      quote:
        "Человек — это социальное существо, и без взаимодействия с обществом он никогда не разовьёт в себе ни одного из своих атрибутов.",
      name: "Л.С. Выготский",
      company: "Культурно-историческая теория",
      image:
